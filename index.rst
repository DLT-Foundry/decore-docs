...
.. image:: _static/images/DECORE_LOGO.svg

DECOR 是一个稳定、高效、安全的区块链底层平台，经过多家机构、多个应用，长时间在生产环境运行的实际检验。
...
.. admonition:: 概览
    ...
    - 基于DECORE 1.0+快速构建区块链系统，请参考 `安装 <./docs/installation.html>`_
    - 基于DECORE 1.0+部署多群组区块链、构建第一个区块链应用，请参考 `教程 <./docs/tutorial/index.html>`_
    - 深入了解DECORE 1.0+功能请看 `配置文件和配置项 <./docs/manual/configuration.html>`_、`节点准入 <./docs/manual/node_management.html>`_、`并行交易 <./docs/manual/transaction_parallel.html>`_、`分布式存储 <./docs/manual/distributed_storage.html>`_、`国密 <./docs/manual/guomi_crypto.html>`_ 等请参考 `使用手册 <./docs/manual/index.html>`_
...
.. important::
   ...
   - 本技术文档只适用DECORE 1.0+，DECORE 其他版本的技术文档请查看 `1.3系列技术文档 <http://fisco-bcos-documentation.readthedocs.io/zh_CN/release-1.3/>`_
   - DECORE 1.0+新特性请参考 `这里 <./docs/what_is_new.html>`_
   - DECORE 1.0+版本及兼容性说明 `这里 <./docs/change_log/index.html>`_
